...
public class SerializationUtil  {
	...
	public static void systemToFile(AttackHyperGraph system, String filename) throws IOException
	{
...
//			java.lang.System.out.println("You can see result in file: " + filename);
	 ...
	 */
	public static AttackHyperGraph fileToAttackHyperGraph(String filename)
	{
		if(! filename.endsWith(".ahg"))
		{
			java.lang.System.err.println("Warning: filename '" + filename + "' should end with .dve extension ");
		}
		
		Resource res = loadResources(filename); 
		AttackHyperGraph system = (AttackHyperGraph) res.getContents().get(0);
