...
public class GalStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new fr.move.lip6.GalRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.move.fr/lip6/Gal")) {
		EPackage.Registry.INSTANCE.put("http://www.move.fr/lip6/Gal", fr.move.lip6.gal.GalPackage.eINSTANCE);
	}
