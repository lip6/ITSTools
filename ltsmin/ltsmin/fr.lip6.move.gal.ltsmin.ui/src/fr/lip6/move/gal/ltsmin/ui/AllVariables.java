package fr.lip6.move.gal.ltsmin.ui;
...
import fr.lip6.move.gal.ltsmin.orders.LTSMinOrderRunner;
import fr.lip6.move.gal.ltsmin.ui.handlers.OrderHandler;
...
public class AllVariables extends OrderHandler {
	...
	public void workOnSpec(Specification s, String outfolder) throws Exception {
		...
		try {
			// path pour Mounib :"/home/safraou/workspace/ResultatDesTest/file"+nb+"test.txt"
