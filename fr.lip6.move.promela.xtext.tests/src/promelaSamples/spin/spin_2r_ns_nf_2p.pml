...
x0_u0_spin_data_out!mess;
            ...
            if 
            ::(mess.tag==2)-> atomic{poss_out0_2!jeton; sortie_up2[0] = 0; goto SUITE_UP;}
            :: else ->
x0_d0_spin_data_in?mess;
            fi;
          od;
...
x0_u1_spin_data_out!mess;
            ...
            if 
            ::(mess.tag==2)-> atomic{poss_out0_3!jeton; sortie_up3[0] = 0; goto SUITE_UP;}
            :: else -> 
x0_d0_spin_data_in?mess;
            fi;
          od;
...
x1_u0_spin_data_out!mess;
            ...
            if 
            ::(mess.tag==2)-> atomic{poss_out1_2!jeton; sortie_up2[1] = 0; goto SUITE_UP;}
            :: else ->
x1_d0_spin_data_in?mess;
            fi;
          od;
...
x1_u1_spin_data_out!mess;
            ...
            if 
            ::(mess.tag==2)-> atomic{poss_out1_3!jeton; sortie_up3[1] = 0; goto SUITE_UP;}
            :: else -> 
x1_d0_spin_data_in?mess;
            fi;
          od;
