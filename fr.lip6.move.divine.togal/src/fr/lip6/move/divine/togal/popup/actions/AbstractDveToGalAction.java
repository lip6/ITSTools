...
//					sb.append(" " + outpath2);
	...
	public abstract GALTypeDeclaration doTransformation(DivineSpecification s, String galName) ;
						...
						((IResource) elt).accept(new IResourceVisitor() {
							...
							public boolean visit(IResource resource) throws CoreException {
								if (resource instanceof IFile) {
									...
									if (file.getFileExtension() != null && file.getFileExtension().equals("dve")) {
										files.add(file);
									}
								}
