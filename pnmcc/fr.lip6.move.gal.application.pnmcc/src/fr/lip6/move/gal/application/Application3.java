...
// */
//public class Application3 implements IApplication, Ender {
//
//	static {
...
//						sr.dropPlaces(implicitPlaces,false,"STM");
//						cont = true;
//						total++;
...
//						if (!implicitPlaces.isEmpty()) {
//							sr.dropPlaces(implicitPlaces,false,"SMT");
...
//					}
//					sr.dropTransitions(tokill,"Redundant transitions covered by linear combinations (found with SMT)");
//					if (!tokill.isEmpty()) {
