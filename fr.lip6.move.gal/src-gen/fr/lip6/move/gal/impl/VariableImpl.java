 ...
 *   <li>{@link fr.lip6.move.gal.impl.VariableImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableImpl extends MinimalEObjectImpl.Container implements Variable
{
  ...
  public void setValue(int newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GalPackage.VARIABLE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GalPackage.VARIABLE__NAME:
        return getName();
      case GalPackage.VARIABLE__VALUE:
        return getValue();
    }
