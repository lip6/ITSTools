...
chan LDreq_3 =[0] of {int};
chan LDres_3 =[0] of {int};
chan LDcon_3 =[0] of {int};
chan LDind_3 =[0] of {int};
chan TX_3 =[0] of {int};
chan PDreq_3 =[0] of {int};
chan PDind_3 =[0] of {int};
chan PAreq_3 =[0] of {int};
chan PAcon_3 =[0] of {int};
chan PCind_3 =[0] of {int};
chan TDreq_3 =[0] of {int};
...
wait_q: if
:: m==124 && dest==4; goto idle; 

:: m==105 && dest<4; goto idle; 

:: m==106 && dest<4; goto idle; 
...
s6: if
::  atomic {dest==4;LDcon_0!124;buf = -1;}  goto link0; 
...
::  atomic {m!=122 && m!=121 && m!=119;LDcon_0!106;dest = 4;}  goto linkWSA; 
...
link3Aq: if
::  atomic {m==119 || m==120 || m==122;LDcon_0!106;dest = 4;}  goto linkWSA; 
...
::  d_step {m2!=122;dest = 4;}  goto linkWSA; 
...
::  d_step {m==119 || m==120 || m==122;dest = 4;}  goto linkWSA; 
...
::  d_step {dest!=122 && dest!=0 && dest!=4;dest = 4;}  goto linkWSA; 
...
:: (m==120 || m==121) && dest==4; goto link4BRec; 
...
s6: if
::  atomic {dest==4;LDcon_1!124;buf = -1;}  goto link0; 
...
::  atomic {m!=122 && m!=121 && m!=119;LDcon_1!106;dest = 4;}  goto linkWSA; 
...
link3Aq: if
::  atomic {m==119 || m==120 || m==122;LDcon_1!106;dest = 4;}  goto linkWSA; 
...
::  d_step {dest!=122 && dest!=1 && dest!=4;dest = 4;}  goto linkWSA; 
...
s6: if
::  atomic {dest==4;LDcon_2!124;buf = -1;}  goto link0; 
...
::  atomic {m!=122 && m!=121 && m!=119;LDcon_2!106;dest = 4;}  goto linkWSA; 
...
link3Aq: if
::  atomic {m==119 || m==120 || m==122;LDcon_2!106;dest = 4;}  goto linkWSA; 
...
::  d_step {dest!=122 && dest!=2 && dest!=4;dest = 4;}  goto linkWSA; 
...
active proctype Transreq_3() { 
byte m=0;

idle: if
:: LDind_3?m; goto got_msg; 

fi;
got_msg: if
::  atomic {m==101;LDres_3!100;}  goto idle; 

:: TX_3?0; goto concatenated_tr; 

::  goto split_tr; 

fi;
concatenated_tr: if
:: LDres_3!102; goto idle; 

fi;
split_tr: if
:: LDres_3!107; goto idle; 

fi;
}

active proctype Transres_3() { 
byte dest=0;
byte m=0;

idle: if
:: TDreq_3?dest; goto got_req; 
...
q: if
:: LDreq_3!dest; goto wait_ack; 

fi;
wait_ack: if
:: LDcon_3?m; goto wait_q; 
...
link0: if
:: LDreq_3?buf; goto link0r; 

:: PAcon_3?m; goto link0a; 

:: PDind_3?m; goto link0i; 

fi;
link0r: if
:: PAreq_3!108; goto link0; 
...
s6: if
::  atomic {dest==4;LDcon_3!124;buf = -1;}  goto link0; 

:: dest<4; goto link3; 

fi;
link3: if
:: PDind_3?m; goto link3q; 

fi;
link3q: if
:: m==121; goto link3; 

::  atomic {m==122;LDcon_3!106;}  goto link0; 

:: m==119; goto link3A; 

::  atomic {m!=122 && m!=121 && m!=119;LDcon_3!106;dest = 4;}  goto linkWSA; 

fi;
link3A: if
:: PDind_3?m; goto link3Aq; 

fi;
link3Aq: if
::  atomic {m==119 || m==120 || m==122;LDcon_3!106;dest = 4;}  goto linkWSA; 

::  ! (m==119 || m==120 || m==122); goto link3RE; 

fi;
link3RE: if
:: PDind_3?m2; goto link3REq1; 

fi;
link3REq1: if
::  atomic {m==112 && (m2==121 || m2==120);LDcon_3!105;}  goto link3REq2; 

::  atomic { ! (m==112 && (m2==121 || m2==120));LDcon_3!106;}  goto link3REq2; 
...
linkWSA: if
:: PDind_3?m; goto linkWSAq; 

::  atomic {dest==3;PAcon_3?m;}  goto linkWSAa1; 
...
linkWSAa1: if
::  atomic {m==110;PCind_3?0;}  goto linkWSAa2; 

fi;
linkWSAa2: if
:: PDreq_3!120; goto link0; 

fi;
link4: if
:: PDind_3?m; goto link4q; 
...
link4DH: if
:: PDind_3?dest; goto link4DHq; 

fi;
link4DHq: if
:: dest==122; goto link0; 

::  atomic {dest==3;PAreq_3!109;}  goto link4RH; 

:: dest==4; goto link4RH; 

::  d_step {dest!=122 && dest!=3 && dest!=4;dest = 4;}  goto linkWSA; 

fi;
link4RH: if
:: PDind_3?m; goto link4RHq; 
...
link4RE: if
:: PDind_3?m; goto link4REq; 

fi;
link4REq: if
:: (m==120 || m==121) && dest==3; goto link4DRec; 
...
link4DRec: if
::  atomic {data==116;LDind_3!103;}  goto link4DRecq; 

::  atomic {data==117;LDind_3!104;}  goto link4DRecq; 

fi;
link4BRec: if
::  atomic {data==116;LDind_3!101;}  goto link0; 

:: data!=116; goto link0; 

fi;
link4DRecq: if
:: PAcon_3?m; goto link4DRecq2; 
...
:: LDres_3?m; goto link6; 

fi;
p1: if
:: PDreq_3!121; goto link5; 
...
p5: if
::  atomic {m==107;PDreq_3!120;}  goto link0; 

::  atomic {m!=107;PDreq_3!121;}  goto link7; 

fi;
p6: if
:: PDreq_3!121; goto link7; 

fi;
link7: if
:: PCind_3?0; goto p6; 

:: LDreq_3?dest; goto link2req; 
...
idle: if
::  ! (t[0]==0 && t[1]==0 && t[2]==0 && t[3]==0); goto arbresgab; 
...
::  atomic {PAreq_3?m;i = 3;}  goto idleq; 

fi;
arbresgab: if
::  d_step {t[0] = 0;t[1] = 0;t[2] = 0;t[3] = 0;}  goto idle; 
...
::  atomic {i==3 && t[i]==1;PAcon_3!111;}  goto idle; 
...
::  atomic {i==3 && t[i]==0;PAcon_3!110;t[i] = 1;busy = i;}  goto bus_busy; 
...
::  atomic {PAreq_3?m;i = 3;}  goto busyq; 
...
::  atomic {busy==3;PCind_3!0;}  goto get_next_packet; 

::  d_step {busy==4 && next[0]==0 && next[1]==0 && next[2]==0 && next[3]==0;j = 0;}  goto sub_action_gab; 

::  d_step {busy==4 &&  ! (next[0]==0 && next[1]==0 && next[2]==0 && next[3]==0);j = 0;}  goto resolve; 
...
::  atomic {m==108 && i==3;PAcon_3!111;}  goto bus_busy; 
...
::  atomic {3==j;PDind_3!122;j = j+1;}  goto sub_action_gab; 
...
::  atomic {busy==3;PDreq_3?m;j = 0;}  goto distribute; 

fi;
resolve: if
::  d_step {j<4 && next[j]==0;j = j+1;}  goto resolve; 
...
::  atomic {3==j && next[j]==1;PAcon_3!110;}  goto resolveq; 
...
::  atomic {3==j;PCind_3!0;j = j+1;}  goto resolve; 
...
::  atomic {PDreq_3?m;j = 3;}  goto resolve2q; 

fi;
resolve2q: if
::  ! ((next[0]==0 && next[1]==0 && next[2]==0 && next[3]==0) || (next[0]+next[1]+next[2]+next[3]==1)) && m!=120; goto resolve; 

::  d_step { ! ((next[0]==0 && next[1]==0 && next[2]==0 && next[3]==0) || (next[0]+next[1]+next[2]+next[3]==1)) && m==120;next[j] = 0;}  goto resolve; 

::  d_step {(next[0]+next[1]+next[2]+next[3]==1) && m==120;next[j] = 0;j = 0;}  goto sub_action_gab; 

::  d_step {(next[0]+next[1]+next[2]+next[3]==1) && m!=120;busy = j;next[j] = 0;j = 0;}  goto distribute; 
...
::  atomic {3==j;PAreq_3?m;}  goto distributeq; 
...
::  atomic {3==j &&  ! (m==114 && destfault[j]==1);PDind_3!m;j = j+1;}  goto distribute; 
...
::  atomic {3==j && m==116;PDind_3!m;}  goto data_dummy; 
...
::  atomic {3==j && m==116;PDind_3!117;j = j+1;}  goto distribute; 
...
::  atomic {3==j && m==114;PDind_3!115;j = j+1;}  goto distribute; 
...
::  atomic {3==j && m==112;PDind_3!113;j = j+1;}  goto distribute; 

::  d_step {j!=busy && j<4 && m<100;destfault[j] = 1;i = 0;}  goto dest_cor; 

::  d_step {j!=busy && j<4 && m<100;destfault[j] = 1;i = 1;}  goto dest_cor; 

::  d_step {j!=busy && j<4 && m<100;destfault[j] = 1;i = 2;}  goto dest_cor; 

::  d_step {j!=busy && j<4 && m<100;destfault[j] = 1;i = 3;}  goto dest_cor; 

:: j==4 && m!=120; goto bus_busy; 

::  d_step {j==4 && m==120;busy = 4;}  goto bus_busy; 
...
::  atomic {m==108 && j==3;PAcon_3!111;}  goto distribute; 
...
::  atomic {3==j;PDind_3!i;j = j+1;}  goto distribute; 
...
::  atomic {3==j;PDind_3!123;j = j+1;}  goto distribute; 
