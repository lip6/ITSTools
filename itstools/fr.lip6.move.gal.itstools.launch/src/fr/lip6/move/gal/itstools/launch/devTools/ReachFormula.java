...
public class ReachFormula {
	...
	public static void instanciate(OptionsTab tab){
		...
		OptionBoolean no_garbage = new OptionBoolean("no-garbage", "disable garbage collection (may be faster, more memory", false);
		...
		stats.setFlag("--stats");
		OptionBoolean edgeStat = new OptionBoolean("EdgeCount", "produces stats on the size of the transition relation, i.e the number of unique soiurce to target state pairs it contains.", true);
